                    ...
                    do {
                        ...
                        switch (opcao) {
                            ...
                            case 3:
                                break;
                            default:
                                System.out.println("Introduziu um valor invalido. \n"
                                        + "Tente novamente.");
                                System.out.println("-------------------------------------------");
                                break;
                        }
...
//                    banco.removerCliente(Menu.lerIntMsg("Por favor, introduza o n�mero de Cliente a ser eliminado: "));
                ...
                case 5:
                    do {
                        System.out.println("TRANSACOES/CONSULTAS:");
...
//                            Menu.lerIntMsg(null); //entrar no cliente atraves do seu n.�, e obter o seu saldo
                            ...
                            case 2:
                                ...
                                System.out.println("Levantar numererio do Cliente numero: ");
                                id = Menu.lerInt();
...
//                                System.out.println(banco.transfereSaldoString(idOrigem, transferencia, idDestino));
                            ...
                            default:
                                System.out.println("===========================================");
                                System.out.println("        Escolheu uma opcao invalida.       ");
